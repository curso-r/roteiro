...
O RStudio nos ajuda a montar nossos trabalhos dentro de pastas a partir dos Projetos. O projeto é um arquivo com extensão `.Rproj` que guarda configurações do projeto. Por exemplo, se carregaremos uma base de dados automaticamente ao abrir o projeto. O nome do arquivo `.Rproj` é igual ao nome da pasta do projeto. Se clicarmos duas vezes nesse arquivo, o RStudio já abre com as configurações do projeto. 
